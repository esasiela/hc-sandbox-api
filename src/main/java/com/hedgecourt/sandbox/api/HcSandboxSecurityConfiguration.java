...
public class HcSandboxSecurityConfiguration {
  private static final Logger log = LoggerFactory.getLogger(HcSandboxSecurityConfiguration.class);

  private final HcPublicPathsMatcherService publicPathsMatcherService;

  public HcSandboxSecurityConfiguration(HcPublicPathsMatcherService publicPathsMatcherService) {
